# fixed-table-layout Specification

## Purpose
Define requirements for using fixed table layout with explicit column widths in the nominal ranking table to prevent text wrapping from destabilizing pre-computed page chunks.
